...
<section class="content">
                          ...
                          <div class="card-box table-responsive">
                            <table id="dataoutlet" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  @endforeach
                                  <tr>
                                    <td colspan="3" style="text-align: right"><a href="{{ route('exceloutlet') }}"  class="btn btn-success" >
                                      <i class="fa fa-file-excel mr-3"></i>Export Excel
                                  </a></td>
                                  <td style="text-align: right"><a href="{{ route('outletPdf') }}"  class="btn btn-danger" >
  ...
  <!-- /.content -->
  <form enctype="multipart/form-data" action="{{ route('importoutlet') }}" method="POST">
    @csrf
    <!-- Modal -->
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="">
              <ul>
                <li><a href="{{ route('downloadoutlet') }}">Unduh</a> Template Excel Paket</li>
              </ul>
            </div>
          </div>
